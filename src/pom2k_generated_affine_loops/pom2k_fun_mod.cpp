// Generated on 2025-06-30 02:23:54
...
extern "C" void copy_real_constants_(real_t* _alpha, real_t* _dte, real_t* _dte2, real_t* _dti,
                                     real_t* _dti2, real_t* _grav, real_t* _hmax, real_t* _kappa,
                                     real_t* _pi, real_t* _ramp, real_t* _rfe, real_t* _rfn,
                                     real_t* _rfs, real_t* _rfw, real_t* _rhoref, real_t* _sbias,
                                     real_t* _slmax, real_t* _small, real_t* _tbias, real_t* _time,
                                     real_t* _tprni, real_t* _umol, real_t* _vmaxl, real_t* _horcon)
{
    alpha = *_alpha;
    dte = *_dte;
    dte2 = *_dte2;
...
extern "C" void copy_int_constants_(int* _iint, int* _iprint, int* _iskp, int* _jskp, int* _kl1,
                                    int* _kl2, int* _mode, int* _ntp)
{
    iint = *_iint;
    iprint = *_iprint;
    iskp = *_iskp;
...
extern "C" void ext_areas_masks_(real_t* art, real_t* aru, real_t* arv, real_t* dum, real_t* dvm,
                                 real_t* fsm, real_t* dx, real_t* dy, real_t* h)
{
    for (int j = 0; j < jm; j++)
    {
        for (int i = 0; i < im; i++)
...
extern "C" void ext_dens_(real_t* si, real_t* ti, real_t* rhoo, real_t* h, real_t* fsm, real_t* zz,
...
extern "C" void ext_seamount_(real_t* dx, real_t* dy, real_t* cor, real_t* east_c, real_t* north_c,
                              real_t* east_e, real_t* north_e, real_t* east_u, real_t* north_u,
                              real_t* east_v, real_t* north_v, real_t* rot, real_t* h, real_t* art,
                              real_t* aru, real_t* arv, real_t* dum, real_t* dvm, real_t* fsm,
                              real_t* tb, real_t* sb, real_t* tclim, real_t* sclim, real_t* ub,
                              real_t* uab, real_t* zz, real_t* elb, real_t* etb, real_t* e_atmos,
                              real_t* dt, real_t* aam2d, real_t* aam, real_t* rho, real_t* tbias,
                              real_t* sbias, real_t* rmean, real_t* uabw, real_t* uabe, real_t* ele,
                              real_t* elw, real_t* tbe, real_t* tbw, real_t* sbe, real_t* sbw,
                              real_t* tbn, real_t* tbs, real_t* sbn, real_t* sbs, real_t* _rfe,
                              real_t* _rfn, real_t* _rfs, real_t* _rfw)
{
...
extern "C" void ext_init_cond_(real_t* _period, real_t* cor, real_t* _time0, real_t* _time,
                               ...
                               real_t* elb, real_t* et, real_t* etb, real_t* etf, real_t* d,
                               real_t* h, real_t* dt, real_t* vfluxf, real_t* w, real_t* l,
                               real_t* q2b, real_t* q2lb, real_t* kh, real_t* km, real_t* kq,
...
extern "C" void ext_baropg_(real_t* rho, real_t* rmean, real_t* drhox, real_t* drhoy, real_t* zz,
                            real_t* dt, real_t* dum, real_t* dvm, real_t* dx, real_t* dy,
                            real_t* ramp)
{
    // C **********************************************************************
    // C *                                                                    *
...
extern "C" void ext_init_internal_(real_t* _time, real_t* _time0, int* iint, real_t* _period,
                                   real_t* _ramp, int* lramp, int* iproblem, real_t* wusurf,
                                   real_t* wvsurf, real_t* dvm, real_t* e_atmos, real_t* vfluxf,
                                   real_t* w, real_t* wtsurf, real_t* wssurf, real_t* swrad,
...
extern "C" void ext_flux_update_(real_t* fluxua, real_t* fluxva, real_t* d, real_t* dy, real_t* dx,
                                 real_t* ua, real_t* va)
{
    for (int j = 1; j < jm; j++)
    {
...
extern "C" void ext_bcond_2_(real_t* uaf, real_t* vaf, real_t* uabe, real_t* uabw, real_t* vabn,
                             real_t* vabs, real_t* h, real_t* el, real_t* ele, real_t* elw,
                             real_t* eln, real_t* els, real_t* dum, real_t* dvm, real_t* ramp,
                             real_t* rfe, real_t* rfw, real_t* rfn, real_t* rfs)
{
    // C
...
C
*/
extern "C" void ext_bcond_3_(real_t* h, real_t* uf, real_t* u, real_t* vf, real_t* v, real_t* dum,
                             real_t* dvm)
{
    /*
            do k=1,kbm1
...
extern "C" void ext_bcond_4_(real_t* uf, real_t* vf, real_t* dx, real_t* u, real_t* s, real_t* t,
                             real_t* sbe, real_t* tbe, real_t* zz, real_t* dt, real_t* tbw,
                             real_t* sbw, real_t* dy, real_t* tbn, real_t* sbn, real_t* tbs,
                             real_t* sbs, real_t* v, real_t* w, real_t* fsm)
{
...
extern "C" void ext_advave_(real_t* curv2d, real_t* advua, real_t* advva, real_t* fluxua,
                            real_t* fluxva, real_t* ua, real_t* va, real_t* uab, real_t* vab,
                            real_t* wubot, real_t* wvbot, real_t* d, real_t* dx, real_t* dy,
                            real_t* aru, real_t* arv, real_t* aam2d, real_t* tps, real_t* cbc)
{
    for (int j = 0; j < jm; j++)
    {
        for (int i = 0; i < im; i++)
...
extern "C" void ext_uaf_(real_t* uaf, real_t* adx2d, real_t* advua, real_t* aru, real_t* cor,
                         real_t* d, real_t* va, real_t* dy, real_t* el, real_t* elb, real_t* elf,
                         real_t* e_atmos, real_t* drx2d, real_t* wusurf, real_t* wubot, real_t* h,
                         real_t* uab)
{
    for (int j = 1; j < jmm1; j++)
    {
...
// Automatcally generated code
extern "C" void ext_vaf_(real_t* vaf, real_t* ady2d, real_t* advva, real_t* arv, real_t* cor,
                         real_t* d, real_t* ua, real_t* dx, real_t* el, real_t* elb, real_t* elf,
                         real_t* e_atmos, real_t* dry2d, real_t* wvsurf, real_t* wvbot, real_t* h,
                         real_t* vab)
{

    int range_ext_vaf_0[] = {1, imm1, 1, jm};

    ops_par_loop(ext_vaf_0, "ext_vaf_0", block, 2, range_ext_vaf_0,
    ...
    int range_ext_vaf_1[] = {1, imm1, 1, jm};

    ops_par_loop(ext_vaf_1, "ext_vaf_1", block, 2, range_ext_vaf_1,
...
extern "C" void ext_etf_update_(int* iext, int* isplit, real_t* smoth, real_t* etf, real_t* elf,
                                real_t* fsm)
{
    if (*iext == *isplit - 2)
    {
...
extern "C" void ext_apply_filter_(real_t* vamax, real_t* vmaxl, real_t* smoth, int* iext,
                                  int* isplit, real_t* ispi, real_t* isp2i, real_t* ua, real_t* uab,
                                  real_t* uaf, real_t* va, real_t* vab, real_t* vaf, real_t* el,
                                  real_t* elb, real_t* elf, real_t* d, real_t* h, real_t* egf,
                                  real_t* utf, real_t* vtf)
{
    if (*vamax < *vmaxl)
    {
        // C
...
extern "C" void ext_vertvl_(real_t* xflux, real_t* yflux, real_t* dx, real_t* dy, real_t* dt,
                            real_t* u, real_t* v, real_t* w, real_t* vfluxb, real_t* vfluxf,
                            real_t* etf, real_t* etb, real_t* dz, real_t* dti2)
{
    // C
...
extern "C" void ext_profu_(real_t* h, real_t* etf, real_t* c, real_t* km, real_t* a, real_t* dz,
                           real_t* dzz, real_t* ee, real_t* gg, real_t* wusurf, real_t* uf,
                           real_t* tps, real_t* cbc, real_t* ub, real_t* vb, real_t* dum,
                           real_t* wubot, real_t* dhloc)
{
...
extern "C" void ext_profv_(real_t* etf, real_t* h, real_t* c, real_t* km, real_t* a, real_t* dz,
                           real_t* dzz, real_t* ee, real_t* gg, real_t* wvsurf, real_t* vf,
                           real_t* tps, real_t* cbc, real_t* ub, real_t* vb, real_t* dvm,
                           real_t* wvbot, real_t* dhloc)
{
    /*
  C **********************************************************************
  C                                                                      *
...
/////
/////*****************************************************************************/////
extern "C" void ext_advct_(real_t* xflux, real_t* yflux, real_t* curv, real_t* advx, real_t* advy,
                           real_t* u, real_t* v, real_t* dx, real_t* dy, real_t* dt, real_t* aam,
                           real_t* ub, real_t* vb, real_t* aru, real_t* arv)
{
...
/////
/////*****************************************************************************/////
extern "C" void ext_add_ad_2d_(real_t* adx2d, real_t* ady2d, real_t* advua, real_t* advva)
{
...
/////
/////*****************************************************************************/////
extern "C" void ext_time_internal_forward_(real_t* egf, real_t* el, real_t* ispi, real_t* utf,
                                           real_t* ua, real_t* d, real_t* isp2i, real_t* vtf,
                                           real_t* va)
{
...
extern "C" void ext_advt1_(real_t* fb, real_t* f, real_t* fclim, real_t* ff, real_t* xflux,
                           ...
                           real_t* dz, real_t* h, real_t* w, real_t* art, real_t* etb, real_t* etf)
{
...
/////
/////*****************************************************************************/////
extern "C" void ext_smol_adif_(real_t* xmassflux, real_t* ymassflux, real_t* zwflux, real_t* ff,
                               real_t* sw, real_t* fsm, real_t* aru, real_t* arv, real_t* dt,
                               real_t* dzz)
{
...
extern "C" void ext_advt2_(real_t* fb, real_t* f, real_t* fclim, real_t* ff, real_t* xflux,
                           real_t* yflux, real_t* zflux, int* nitera, real_t* sw, real_t* u,
                           real_t* v, real_t* dt, real_t* aam, real_t* dum, real_t* dvm, real_t* dx,
                           real_t* dy, real_t* dz, real_t* h, real_t* w, real_t* art, real_t* etb,
                           real_t* etf, real_t* fsm, real_t* aru, real_t* arv, real_t* dzz,
                           real_t* fbmem, real_t* eta, real_t* xmassflux, real_t* ymassflux,
                           real_t* zwflux)
{
...
/////
/////*****************************************************************************/////
extern "C" void ext_final_internal_update_(real_t* egb, real_t* egf, real_t* etb, real_t* et,
                                           real_t* etf, real_t* dt, real_t* h, real_t* utb,
                                           real_t* utf, real_t* vtb, real_t* vtf, real_t* vfluxb,
                                           real_t* vfluxf)
{
...
/////
/////*****************************************************************************/////
extern "C" void ext_advu_(real_t* u, real_t* uf, real_t* ub, real_t* v, real_t* w, real_t* advx,
                          real_t* aru, real_t* dy, real_t* dz, real_t* cor, real_t* dt, real_t* egf,
                          real_t* egb, real_t* e_atmos, real_t* drhox, real_t* h, real_t* etf,
                          real_t* etb)
{
...
/////
/////*****************************************************************************/////
extern "C" void ext_advv_(real_t* v, real_t* vf, real_t* vb, real_t* u, real_t* w, real_t* advy,
                          real_t* arv, real_t* dx, real_t* dz, real_t* cor, real_t* dt, real_t* egf,
                          real_t* egb, real_t* e_atmos, real_t* drhoy, real_t* h, real_t* etf,
                          real_t* etb)
{
...
extern "C" void ext_save_state_for_restart_(
    real_t* time, real_t* wubot, real_t* wvbot, real_t* aam2d, real_t* ua, real_t* uab, real_t* va,
    real_t* vab, real_t* el, real_t* elb, real_t* et, real_t* etb, real_t* egb, real_t* utb,
    real_t* vtb, real_t* u, real_t* ub, real_t* w, real_t* v, real_t* vb, real_t* t, real_t* tb,
    real_t* s, real_t* sb, real_t* rho, real_t* adx2d, real_t* ady2d, real_t* advua, real_t* advva,
    real_t* km, real_t* kh, real_t* kq, real_t* l, real_t* q2, real_t* q2b, real_t* aam,
    real_t* q2l, real_t* q2lb)
{
...
extern "C" void ext_profq_(real_t* sm, real_t* sh, real_t* dh, real_t* cc, real_t* h, real_t* etf,
                           ...
                           real_t* kh, real_t* vf, real_t* fsm, real_t* q2, real_t* dt, real_t* rho,
                           real_t* dtef, real_t* l0, real_t* gh, real_t* boygr, real_t* stf,
...
extern "C" void ext_proft_(real_t* f, real_t* wfsurf, real_t* fsurf, int* nbc, real_t* dh,
                           real_t* h, real_t* etf, real_t* a, real_t* kh, real_t* c, real_t* z,
                           real_t* swrad, real_t* ee, real_t* gg, real_t* dz, real_t* dzz,
                           real_t* rad2)
{
...
extern "C" void ext_save_2d_array_(char* fname, real_t* data, int* iint, int* iext, int* isplit)
{
    char fn[100];
...
extern "C" void ext_save_3d_array_(char* fname, real_t* data, int* iint, int* iext, int* isplit)
{
    char fn[100];
    int frame = *iint;
    // sprintf(fn,"%s_%04d_%04d.raw",fname,*iint,*iext);
...
/////
/////*****************************************************************************/////
extern "C" void save_3d_array_fort_(char* fname, real_t* data, int* _im, int* _jm, int* _kb)
{
    FILE* fptr = fopen(fname, "ab");
...
/////
/////*****************************************************************************/////
extern "C" void save_3d_array_fort2_(char* fname, real_t* data, int* _im, int* _jm, int* _kb)
{
