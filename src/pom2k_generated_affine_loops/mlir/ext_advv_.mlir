    ...
    affine.for %arg18 = 1 to %11 {
      affine.for %arg19 = 1 to %14 {
        affine.for %arg20 = 0 to %15 {
          ...
          %45 = affine.load %arg4[%arg20 + (%arg19 - 1) * symbol(%15) + (%arg18 * symbol(%15)) * symbol(%14)] : memref<?xf32>
    ...
    affine.for %arg18 = 0 to %17 {
      ...
      affine.for %arg19 = 1 to %26 {
        affine.for %arg20 = 1 to %27 {
          ...
          %57 = affine.load %arg3[%arg20 + %arg19 * symbol(%28) + (%arg18 * symbol(%28)) * symbol(%29) + 1] : memref<?xf32>
          ...
          %87 = affine.load %arg7[%arg20 + (%arg19 - 1) * symbol(%28)] : memref<?xf32>
    ...
    affine.for %arg18 = 0 to %32 {
      affine.for %arg19 = 1 to %39 {
        affine.for %arg20 = 1 to %40 {
          ...
          %46 = arith.addf %44, %45 : f32
          %47 = affine.load %arg15[%arg20 + (%arg19 - 1) * symbol(%41)] : memref<?xf32>
          %48 = arith.addf %46, %47 : f32
          %49 = affine.load %arg17[%arg20 + (%arg19 - 1) * symbol(%41)] : memref<?xf32>
          %50 = arith.addf %48, %49 : f32
          ...
          %61 = affine.load %arg16[%arg20 + (%arg19 - 1) * symbol(%41)] : memref<?xf32>
