    ...
    affine.for %arg7 = 0 to %2 {
      affine.for %arg8 = 0 to %8 {
        affine.for %arg9 = 0 to %9 {
          %11 = affine.load %arg4[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
          %12 = affine.load %arg1[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
          %13 = arith.addf %11, %12 : f32
          %14 = affine.load %arg0[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
          %15 = arith.mulf %14, %cst : f32
          %16 = arith.subf %13, %15 : f32
          %17 = arith.mulf %10, %16 : f32
          %18 = arith.addf %14, %17 : f32
          affine.store %18, %arg0[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
          %19 = affine.load %arg5[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
          %20 = affine.load %arg3[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
          %21 = arith.addf %19, %20 : f32
          %22 = affine.load %arg2[%arg9 + %arg8 * symbol(%9) + (%arg7 * symbol(%9)) * symbol(%8)] : memref<?xf32>
