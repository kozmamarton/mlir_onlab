...
C
     ...
     $  dhloc(im,jm)   ,l0(im,jm)      ,eta(im,jm)
...
C
     ...
     $  tclim          ,t              ,ub             ,uf             ,
     $  u              ,vb             ,vf             ,v              ,
     $  w              ,zflux          ,rad2, gh, boygr, stf, prod     ,
...
C
     ...
     $  w(im,jm,kb)    ,zflux(im,jm,kb),rad2(im,jm,kb) ,
     $  gh(im,jm,kb), boygr(im,jm,kb), stf(im,jm,kb), prod(im,jm,kb)   ,
     $  fbmem(im,jm,kb), xmassflux(im,jm,kb), ymassflux(im,jm,kb)      ,
     $  zwflux(im,jm,kb)
