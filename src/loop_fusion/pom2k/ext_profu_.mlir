  ...
  func.func @ext_profu_(%arg0: memref<?xf32> {polygeist.name = "h", polygeist.type = "float *"}, %arg1: memref<?xf32> {polygeist.name = "etf", polygeist.type = "float *"}, %arg2: memref<?xf32> {polygeist.name = "c", polygeist.type = "float *"}, %arg3: memref<?xf32> {polygeist.name = "km", polygeist.type = "float *"}, %arg4: memref<?xf32> {polygeist.name = "a", polygeist.type = "float *"}, %arg5: memref<?xf32> {polygeist.name = "dz", polygeist.type = "float *"}, %arg6: memref<?xf32> {polygeist.name = "dzz", polygeist.type = "float *"}, %arg7: memref<?xf32> {polygeist.name = "ee", polygeist.type = "float *"}, %arg8: memref<?xf32> {polygeist.name = "gg", polygeist.type = "float *"}, %arg9: memref<?xf32> {polygeist.name = "wusurf", polygeist.type = "float *"}, %arg10: memref<?xf32> {polygeist.name = "uf", polygeist.type = "float *"}, %arg11: memref<?xf32> {polygeist.name = "tps", polygeist.type = "float *"}, %arg12: memref<?xf32> {polygeist.name = "cbc", polygeist.type = "float *"}, %arg13: memref<?xf32> {polygeist.name = "ub", polygeist.type = "float *"}, %arg14: memref<?xf32> {polygeist.name = "vb", polygeist.type = "float *"}, %arg15: memref<?xf32> {polygeist.name = "dum", polygeist.type = "float *"}, %arg16: memref<?xf32> {polygeist.name = "wubot", polygeist.type = "float *"}, %arg17: memref<?xf32> {polygeist.name = "dhloc", polygeist.type = "float *"}) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg18 = %c0 to %11 step %c1 {
      ...
      scf.for %arg19 = %c0 to %93 step %c1 {
        ...
        %99 = memref.load %arg1[%97] : memref<?xf32>
        %100 = arith.addf %98, %99 : f32
        %101 = memref.load %arg0[%96] : memref<?xf32>
        %102 = arith.addf %100, %101 : f32
        %103 = memref.load %arg1[%96] : memref<?xf32>
        %104 = arith.addf %102, %103 : f32
        %105 = arith.mulf %104, %cst_0 : f32
        memref.store %105, %arg17[%97] : memref<?xf32>
      }
    }
    ...
    scf.for %arg18 = %c0 to %14 step %c1 {
      ...
      scf.for %arg19 = %c0 to %93 step %c1 {
        ...
        scf.for %arg20 = %c0 to %94 step %c1 {
          ...
          %104 = arith.addf %102, %103 : f32
          %105 = arith.mulf %104, %cst_0 : f32
          memref.store %105, %arg2[%101] : memref<?xf32>
        }
      }
    }
    ...
    scf.for %arg18 = %c0 to %77 step %c1 {
      ...
      scf.for %arg19 = %c0 to %93 step %c1 {
        ...
        %99 = memref.load %arg12[%96] : memref<?xf32>
        %100 = arith.addf %98, %99 : f32
        %101 = arith.mulf %100, %cst_0 : f32
        %102 = arith.addi %arg19, %71 : index
        %103 = arith.addi %102, %95 : index
        %104 = arith.addi %103, %c1 : index
        %105 = memref.load %arg13[%104] : memref<?xf32>
        %106 = arith.mulf %105, %105 : f32
        %107 = memref.load %arg14[%104] : memref<?xf32>
        %108 = arith.addi %arg18, %c2 : index
        %109 = arith.muli %108, %67 overflow<nsw> : index
        %110 = arith.addi %102, %109 : index
        %111 = arith.addi %110, %c1 : index
        %112 = memref.load %arg14[%111] : memref<?xf32>
        %113 = arith.addf %107, %112 : f32
        %114 = memref.load %arg14[%103] : memref<?xf32>
        %115 = arith.addf %113, %114 : f32
        %116 = memref.load %arg14[%110] : memref<?xf32>
        %117 = arith.addf %115, %116 : f32
        %118 = arith.mulf %117, %cst : f32
        %119 = arith.mulf %118, %118 : f32
        %120 = arith.addf %106, %119 : f32
        %121 = math.sqrt %120 : f32
        %122 = arith.mulf %101, %121 : f32
        memref.store %122, %arg11[%97] : memref<?xf32>
        %123 = memref.load %arg2[%104] : memref<?xf32>
        %124 = arith.addi %arg19, %74 : index
        %125 = arith.addi %124, %95 : index
        %126 = arith.addi %125, %c1 : index
        %127 = memref.load %arg8[%126] : memref<?xf32>
        %128 = arith.mulf %123, %127 : f32
        %129 = memref.load %arg10[%104] : memref<?xf32>
        %130 = arith.subf %128, %129 : f32
        %131 = memref.load %arg11[%97] : memref<?xf32>
        %132 = arith.mulf %131, %65 : f32
        %133 = memref.load %arg17[%97] : memref<?xf32>
        %134 = arith.mulf %76, %133 : f32
        %135 = arith.divf %132, %134 : f32
        %136 = arith.subf %135, %cst_1 : f32
        %137 = memref.load %arg7[%126] : memref<?xf32>
        %138 = arith.subf %137, %cst_1 : f32
        %139 = arith.mulf %138, %123 : f32
        %140 = arith.subf %136, %139 : f32
        %141 = arith.divf %130, %140 : f32
        memref.store %141, %arg10[%104] : memref<?xf32>
        %142 = memref.load %arg10[%104] : memref<?xf32>
        %143 = memref.load %arg15[%97] : memref<?xf32>
        %144 = arith.mulf %142, %143 : f32
        memref.store %144, %arg10[%104] : memref<?xf32>
      }
    }
