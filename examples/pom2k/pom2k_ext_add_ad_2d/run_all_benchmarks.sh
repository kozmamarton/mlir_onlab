...
CPU_GENERATED_LL="${CPU_GENERATED_LL:-$PROJECT_ROOT/artifacts/llvm/pom2k/cpu/ext_add_ad_2d__cpu.ll}"
CPU_EXAMPLE_LL="${CPU_EXAMPLE_LL:-$SCRIPT_DIR/ext_add_ad_2d_cpu.ll}"
GPU_GENERATED_LL="${GPU_GENERATED_LL:-$PROJECT_ROOT/artifacts/llvm/pom2k/ext_add_ad_2d_.ll}"
GPU_EXAMPLE_LL="${GPU_EXAMPLE_LL:-$SCRIPT_DIR/ext_add_ad_2d_.ll}"
