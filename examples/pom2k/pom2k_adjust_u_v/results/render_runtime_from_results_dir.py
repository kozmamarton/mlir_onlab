...
BENCHMARK_ORDER = ["cpu_single_threaded", "cpu_multithreaded", "gpu_cuda"]
BENCHMARK_LABEL = {
    "cpu_single_threaded": "Egyszálas végrehajtás",
    "cpu_multithreaded": "Többszálas végrehajtás",
    "gpu_cuda": "GPU végrehajtás",
}
BENCHMARK_COLOR = {
    "cpu_single_threaded": "#4E79A7",
    "cpu_multithreaded": "#59A14F",
    "gpu_cuda": "#E15759",
}
...
def hardware_label_for_row(row: Dict[str, str]) -> str:
    ...
    if benchmark == "cpu_single_threaded":
        model = cpu_model if cpu_model and cpu_model.upper() != "N/A" else "CPU"
        return model
