...
int main() {
    ...
    auto args = std::make_unique<ExtAddAd2DCallArgs>(ExtAddAd2DCallArgs{
            adx2d, adx2d, 0, static_cast<int64_t>(n), 1,
            ady2d, ady2d, 0, static_cast<int64_t>(n), 1,
            advua, advua, 0, static_cast<int64_t>(n), 1,
            advva, advva, 0, static_cast<int64_t>(n), 1,
    });
    ...
    std::cout << '\n' <<"Kernel call time: " << elapsed_us << " us (" << elapsed_ms << " ms)\n\n";
